...
proto.prepRepos = function prepRepos (callback) {
    ...
    console.log('refTable', JSON.stringify(self.refTable, null, 4));
    console.log(tasks.length);
    console.log(tasks);
    // Limit the repo building to 3 at a time
    async.parallelLimit(tasks, 3, function () {
        console.log('parallelLimit complete');
        callback();
    });
};
