        ...
        refs.forEach(function (ref) {
            ...
            for (agent in data[test]) {
                ...
                if (data[test][agent].refs[ref].slower) {
                    row.push(data[test][agent].refs[ref].average.toFixed(0) + data[test][agent].refs[ref].unit + ' ±' + data[test][agent].refs[ref].errorMargin.toFixed(2) + '% (' + data[test][agent].refs[ref].slower.toFixed(0) + '% slower)');
                }
                else {
                    row.push(data[test][agent].refs[ref].average.toFixed(0) + data[test][agent].refs[ref].unit + ' ±' + data[test][agent].refs[ref].errorMargin.toFixed(2) + '%');
                }
            }
