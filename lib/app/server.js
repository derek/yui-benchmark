...
console.log('readFile 1 ' + yuiBenchPath + 'assets/template.html');
...
console.log('readFile 2 ' + yuiBenchPath + req.url);
...
console.log('readFile 3 ' + yuiBenchPath + 'node_modules/benchmark/benchmark.js');
...
exports.yuibenchmarkjs = function (req, res) {
    res.writeHead(200, {'Content-Type': 'text/javascript; charset=utf-8'});
console.log('readFile 4 ' + yuiBenchPath + 'assets/yui-benchmark.js');
...
console.log('readFile 5 ' + path.join(yuipath, '/build/', req.params[0]));
...
console.log('readFile 6 ' + yuiBenchPath + '/assets/yui-benchmark.js');
...
console.log('readFile 7 ' + srcPath);
        var fileContents = fs.readFileSync(srcPath, 'utf8'),
