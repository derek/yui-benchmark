...
/**
 * A "Task" is an individual URL fed to Yeti, so an instance of this object stores all the information needed to construct that page
 *
 * @public
...
function Task (config) {
    ...
    tests = refs.map(function refToTest(ref) {
 ...
 * 
 * @public
 * @param {Number} An ID referencing a Task object
