...
options.wip        = (options.wip === undefined ? true : options.wip);
...
options.timeout    = (options.timeout === undefined ? 300: options.timeout) * 1000; // Convert to seconds
options.multiseed  = (options.multiseed === undefined ? false : options.multiseed);
